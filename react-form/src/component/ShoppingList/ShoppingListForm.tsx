        ...
        <div className="flex flex-col items-center justify-center">
            ...
            <form className="flex space-x-2 items-end">
                <div className="flex flex-col space-y-1">
                    ...
                    <input id="product" name="product" onChange={handleChange} value={formData.product} className="w-full px-4 py-2 rounded" type="text" placeholder="Enter your product" />
                </div>
                <div className="flex flex-col space-y-1">
                    <label htmlFor="quantity" className="text-white text-lg">Quantity:</label>
                    <input id="quantity" min={1} step={1} name="quantity" onChange={handleChange} value={formData.quantity} className="w-full px-4 py-2 rounded" type="number" placeholder="Enter your quantity" />
                </div>
